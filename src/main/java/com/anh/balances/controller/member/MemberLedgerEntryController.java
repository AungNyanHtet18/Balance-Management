...
import com.anh.balances.controller.member.dto.LedgerEntryFormItem;
import com.anh.balances.controller.member.dto.LedgerEntrySearch;
import com.anh.balances.controller.member.dto.LedgerSelectItem;
import com.anh.balances.model.entity.consts.BalanceType;
import com.anh.balances.service.LedgerEntryService;
...
public class MemberLedgerEntryController {
	...
	String removeItem(@ModelAttribute(name="form") LedgerEntryForm entryForm) {
		...
		/*
		var removeItems =  entryForm.getItems().stream().filter(a-> !a.isDeleted()).toList();
	...
	LedgerEntryForm ledgerEntryForm(@PathVariable BalanceType type,
