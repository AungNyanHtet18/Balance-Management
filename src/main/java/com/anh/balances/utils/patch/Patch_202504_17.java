package com.anh.balances.utils.patch;
...
public class Patch_202504_17 {
	...
	@Transactional
	@EventListener(classes = ContextRefreshedEvent.class)  //run this method when icon is refreshed
	public void execute() {
