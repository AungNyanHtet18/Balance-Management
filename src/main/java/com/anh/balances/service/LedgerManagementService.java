...
import com.anh.balances.controller.member.dto.LedgerListItem;
...
public class LedgerManagementService {
	...
	public void save(LedgerForm ledgerForm) {
		...
		var entity = Optional.ofNullable(ledgerForm.getId())
				            /* 
				              .map(id -> ledgerRepo.findById(id)) //optional<integer>
				              .map(a -> a.get())          //optional<optional<ledger>>
				              use flatmap instead of double map
				            */ 
