document.addEventListener('DOMContentLoaded',()=>{
	...
	am5.ready(() =>{
       ...
       let balanceRoot = am5.Root.new('balanceChart')
   ...
   function loadBalanceChart(data){
	 ...
	 // Create root element
	  // https://www.amcharts.com/docs/v5/getting-started/#Root_element
	  let expenseRoot = am5.Root.new('expensesChart');
	  ...
	  // Create chart
	  // https://www.amcharts.com/docs/v5/charts/percent-charts/pie-chart/
	  let expenseChart = expenseRoot.container.children.push(
	  ...
	  // Create series
	  // https://www.amcharts.com/docs/v5/charts/percent-charts/pie-chart/#Series
	  let expenseSeries = expenseChart.series.push(
