      ...
      <app:form-group label="Type" cssClass="col-auto">
       ...
       <app:form-group label="Keyword" cssClass="col-auto">
        ...
        <div class="col btn-wrapper">
           ...
           <button id="addNewBtn" type="button" class="btn btn-danger"> <!--  not to automically submit, use (type ="button")-->
    ...
    <app:pagination pageResult="${result}"/>
      ...
      <div id="editDialog" class="modal fade">
           <div class="modal-dialog">
               <sf:form id="editForm"  class="modal-content" modelAttribute="form" method ="post">
