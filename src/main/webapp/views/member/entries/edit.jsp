...
<app:layout-member title="${type.name().toUpperCase()}">
   ...
   <div class="d-flex justify-content-between align-items-start">
       <app:page-title title="${form.id eq null ? 'Add New' : 'Edit'} Incomes"></app:page-title>
   </div>
    
   <sf:form id="editForm" action="${root}/member/entry/${urlType}/save" modelAttribute="form"  class="row" method="post">
       ...
       <div class="card">
        ...
        <!-- Particular -->
       	 <app:form-group label="Particular" cssClass="mb-3">
       	     <sf:textarea path="particular" cols="40" rows="3" class="form-control" placeholder="Please enter particular"></sf:textarea>
       	...
       	<!-- Total -->  
       	  <app:form-group label="Total Amount">
       	      <span id="allTotal" class="form-control">0</span>
       	  </app:form-group> 
           	        ...
           	        <div class="row mt-2 ${item.deleted ? 'd-none' : ''}">
           	           ...
           	           <div class="col">
           	               <div class="input-group">
           	                   <button data-delete-input-id="items${sts.index}.deleted" data-delete-url="${root}/member/entry/${urlType}/item/remove"  type="button"  class="deletedBtn btn btn-outline-danger input-group-text">
           	                       <i class="bi-trash"></i>
           	                   </button>
           	            ...
           	            <div class="col-2 text-end">
           	                 <span id="row${sts.index}Total" class="form-control">
           	                    0
           	                 </span>
           	            </div>
           	          </div>
