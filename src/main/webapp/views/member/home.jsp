   ...
   <div class="row">
      <div class="col-3">
        <!-- Profile -->
          <div class="card">
          	<div class="card-body">
          	 ...
          	 <img src="${root}/resources/photos/${profile.profileImage()}" alt="Profile Image" class="profile-image"/>
       ...
       <div class="col">
        ...
        <div class="row">
           <div class="col">
               <app:summary-info title="Expenses" icon="bi-cart" color="text-bg-danger" />
           </div>
           <div class="col">
               <app:summary-info title="Incomes" icon="bi-flag" 	color="text-bg-warning"/>
           </div>
           <div class="col">
            <app:summary-info title="Balances" icon="bi-bar-chart" color="text-bg-primary"/>
           </div>
        </div>
